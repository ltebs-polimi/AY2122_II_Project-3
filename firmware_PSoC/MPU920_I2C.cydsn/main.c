...
// DEFINITIVE PSOC CODE FOR SENDING DATA COLLECTED FROM IMU MPU9250 SENSOR
// STILL MISS THE BUTTON-LED FUNCTIONS
...
#define N_FRAME 10 //change it to 10
int flag_data_ready = 0; 
int i;
int k;
uint8_t packet_to_send[(N_FRAME*12)+2]; // 1 packet of data to send contains 10 frame of data + header and tail
