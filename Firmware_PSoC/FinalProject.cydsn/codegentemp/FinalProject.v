...
module top ;
    ...
    I2C_v3_50_0 I2C_MPU9250_Master (
        .bclk(Net_1),
        .clock(1'b0),
        .iclk(Net_3),
        .itclk(Net_4),
	...
	wire [0:0] tmpOE__MPU9250_INT_net;
	wire [0:0] tmpIO_0__MPU9250_INT_net;
	wire [0:0] tmpINTERRUPT_0__MPU9250_INT_net;
	electrical [0:0] tmpSIOVREF__MPU9250_INT_net;

	cy_psoc3_pins_v1_10
		#(.id("41808de2-d8ed-40cc-86e6-0acf833add37"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		MPU9250_INT
		 (.oe(tmpOE__MPU9250_INT_net),
		  .y({1'b0}),
		  .fb({Net_74}),
		  .io({tmpIO_0__MPU9250_INT_net[0:0]}),
		  .siovref(tmpSIOVREF__MPU9250_INT_net),
		  .interrupt({tmpINTERRUPT_0__MPU9250_INT_net[0:0]}),
		  .annotation({Net_76}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__MPU9250_INT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("7379e3c6-c09c-474e-8c1f-bc778f5b3ada"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("157e3951-457e-47bd-833b-b0b7bb1c75fa"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 BUTTON (
        .connect({
            Net_77,
            Net_369
        })
    );
    defparam BUTTON.comp_name = "ButtonSw_sm1_v1_0";
    defparam BUTTON.port_names = "T1_1, T2_1";
    defparam BUTTON.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("675ab9eb-aa93-4cbd-84e4-682d0dba2b5b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    defparam GND_3.comp_name = "Gnd_sm1_v1_0";
    ...
    defparam R.comp_name = "Resistor_sm1_v1_0";
    ...
    defparam GND.comp_name = "Gnd_sm1_v1_0";
	...
	cy_psoc3_pins_v1_10
		#(.id("52f09ff8-4de3-4da2-8684-b2ed4e8b7693"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
