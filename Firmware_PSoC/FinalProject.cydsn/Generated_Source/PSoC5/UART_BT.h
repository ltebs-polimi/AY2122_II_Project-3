...
#define UART_BT_TX_BUFFER_SIZE                 (512u)
...
/* Only if TX is enabled */
    ...
    void UART_BT_PutArray(const uint8 string[], uint16 byteCount)
                                                            ;
    ...
    uint16 UART_BT_GetTxBufferSize(void)
                                                            ;
    /* Obsolete functions, defines for backward compatible */
...
extern uint8 UART_BT_initVar;
    ...
    extern volatile uint16 UART_BT_txBufferRead;
    extern uint16 UART_BT_txBufferWrite;
